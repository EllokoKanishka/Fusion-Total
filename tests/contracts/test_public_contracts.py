...
PUBLIC_METHOD_PARAMETERS = {
    ...
    "dictation_turn_text": ("text", "commands_enabled", "require_wake_word"),
    "dictation_turn_audio": ("path", "mime", "commands_enabled"),
    "dictation_speak": ("text",),
    "dictation_assistant_status": (),
    "set_dictation_assistant": ("provider_id",),
    "dictation_assist": ("text", "draft", "selection_start", "selection_end"),
    "dialogue_reset": (),
