...
class ExternalResearchTests(unittest.TestCase):
    ...
    def test_dialogue_research_request_routes_to_bridge(self):
        bridge = NullExternalResearchBridge(
            ExternalResearchResult(True, answer="Result", spoken_answer="Result", provider="null")
        )
    ...
    def test_dialogue_research_results_are_returned_directly(self):
        bridge = NullExternalResearchBridge(
            ExternalResearchResult(
                True,
                answer="Resultado de prueba",
                spoken_answer="Resultado de prueba",
                provider="null",
                summary="Data crucial",
                query="algo",
                findings=[],
                sources=[],
            )
