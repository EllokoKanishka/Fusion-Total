...
- La suite de tests de exportación quedó aislada con `audio_export_root` inyectable, sandboxes temporales autoeliminados y helpers de espera; no debe escribir en la Descargas real del usuario.
